...
/// 모든 정보가 다 작성되면
if ((inWrap.style.display == "flex") && inForm.job.value && inForm.name.value && inForm.nickname.value && inForm.password.value) {
    
    inSubmit.classList.remove("hide");
} else {
    inSubmit.classList.add("hide");
} 

if ((upWrap.style.display == "flex") && upForm.job.value && upForm.name.value && upForm.nickname.value && upForm.password.value && upForm.passwordChk.value && upForm.email.value && upForm.phone.value) {
